    ...
    <div class="content min-vh-100 mx-auto d-flex align-items-center justify-content-center">
        <form class="outline" method="post" action="">
            ...
            <div class="mb-3 ">
                ...
                <input type="text" class="boxing form-control" name="email" id="FullName" autocomplete="none">
            </div>
            <div class="mb-3 ">
            ...
            <div class="mb-3">
                ...
                <input type="password" class="boxing form-control" name="password" id="confirmPassword" autocomplete="none">
            </div>
